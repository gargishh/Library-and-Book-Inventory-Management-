...
//[0-9]* will make sure to allow the expression to have zeros after the first digit.
        ...
        Matcher m9 = p9.matcher(textField9.getText());
            ...
            if(ae.getSource() == button1){
                if(textField1.getText().equals("")||textField2.getText().equals("")||textField3.getText().equals("")
                   ...
                   ||area.getText().equals("")||textField6.getText().equals("") ||textField7.getText().equals("") ||textField9.getText().equals("") )
                {
                  ...
                  else if( m9.matches()==false )
                {
                     JOptionPane.showMessageDialog(null, "Enter correct Salary ", "", JOptionPane.WARNING_MESSAGE); 
                        ...
                        String queryUsername = "SELECT phoneno FROM STAFF ";
             PreparedStatement psUser = c.con.prepareStatement(queryUsername);
                      ...
                      String query = "INSERT INTO STAFF (fname,lname,age,gender,address,phoneno,mail,designation,salary) values(?,?,?,?,?,?,?,?,?)";
		...
		ps.setString(5, area.getText());
                ...
                ps.setString(8, (String)comboBoxD.getSelectedItem());
