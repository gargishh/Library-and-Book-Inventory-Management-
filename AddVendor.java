...
public class AddVendor extends JFrame implements ActionListener{
     ...
     JPanel panel;
     JTextField textField1,textField2,textField3,textField6,textField7;
     JButton button1,button2;
     JLabel labelimage,label1,label2,label3,label4,label5,label6,label7;
...
//	panel.add(textField5);
	...
	textField6.setBounds(150, 250, 330, 20);
...
//[0-9]* will make sure to allow the expression to have zeros after the first digit.
       ...
       // Matcher m3 = p3.matcher(textField3.getText());
        ...
        Matcher m6 = p6.matcher(textField6.getText());
            ...
            if(ae.getSource() == button1){
                if(textField1.getText().equals("")||textField2.getText().equals("")||textField3.getText().equals("")
                   ...
                   ||area.getText().equals("")||textField6.getText().equals("") ||textField7.getText().equals("")  )
                {
                     ...
                     else if( matchm.matches()==false )
                {
                    ...
                    /*  
                      ...
                      { System.out.println("ResultSet in empty in Java"); } 
                          ...
                          do { String data = rs.getString("emp_name"); System.out.println(data); } while (rs.next()); }
*/
  int answer=JOptionPane.showConfirmDialog(null,  "Name cannot be updated later!\n Save changes?", "", JOptionPane.YES_NO_OPTION);
                
                    //System.out.println(answer);
                    if(answer==0)
                    {
                       String queryUsername = "SELECT phoneno FROM VENDOR ";
             PreparedStatement psUser = c.con.prepareStatement(queryUsername);
                                     ...
                                     {
                                         String query = "INSERT INTO VENDOR (fname,lname,age,gender,address,phoneno,mail) values(?,?,?,?,?,?,?)";
		...
		if (count > 0)
                ...
                textField7.setText("");
                                     ...
                                     {
                                        //System.out.println(rsUser.getString("phoneno"));
                                         
                                         if(textField6.getText().equals(rsUser.getString("phoneno")) )
                                        {
                                             JOptionPane.showMessageDialog(null, "Phoneno already Exists", "", JOptionPane.INFORMATION_MESSAGE);
