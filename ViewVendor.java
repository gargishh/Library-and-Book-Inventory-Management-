...
public class ViewVendor extends JFrame implements ActionListener{
	...
	panel.add(label7);
        ...
        label8 = new JLabel("Order Requests");
	label8.setFont(new Font("Times New Roman",Font.BOLD,15));
        label8.setForeground(Color.black);
	label8.setBounds(40, 310, 120, 30);
	panel.add(label8);
...
//	panel.add(textField5);
	...
	panel.add(textField8);*/
        ...
        String ch1[] = {"---Select---"};
        comboBoxr = new JComboBox(ch1);
        comboBoxr.setBounds(150,310,330,20);
        comboBoxr.addActionListener(this);
        panel.add(comboBoxr);
...
//	panel.add(textField10);
    ...
    try{
        ...
        if(e.getSource()==button1)
       {
           ...
           String query = "SELECT * FROM VENDOR WHERE phoneno=?";
         ...
         {
               JOptionPane.showMessageDialog(null, "Vendor Details Not available", "", JOptionPane.INFORMATION_MESSAGE);
            ...
            String query2 = "SELECT title from request  join vendor on vendor.fname=request.vendor where vendor.phoneno = ?";
           ...
           ResultSet rs2 = ps2.executeQuery();
            ...
            comboBoxr.addItem("---Select---");
           while(rs2.next())
           {
      
         comboBoxr.addItem(rs2.getString("title"));
            ...
            else if(e.getSource()==button3)
            {
                     ...
                     else if( matchm.matches()==false )
                {
                     JOptionPane.showMessageDialog(null, "Enter correct Email ", "", JOptionPane.WARNING_MESSAGE); 
                                ...
                                String query = "UPDATE VENDOR SET fname=?,lname=?,age=?,gender=?,address=?,mail=? WHERE phoneno=?";
                                PreparedStatement ps = c.con.prepareStatement(query);
                                ...
                                if(count>0)
                                    ...
                                    JOptionPane.showMessageDialog(null, "Unable to update details", "", JOptionPane.INFORMATION_MESSAGE);
            ...
            else if(e.getSource()==button4)
            {
                if(textField2.getText().equals(""))
                {
                    JOptionPane.showMessageDialog(null, "Vendor does not exist!", "", JOptionPane.INFORMATION_MESSAGE);
                }
                
                else
                {
                    int answer=JOptionPane.showConfirmDialog(null,  "This will permanently delete the Vendor details from system.\nDo you want to delete this details?", "", JOptionPane.YES_NO_OPTION);
                    ...
                    if(answer==0)
                    {
                         ...
                         String query1 = "DELETE FROM VENDOR WHERE phoneno=?";
                       ...
                       // System.out.println(count1+" records deleted"); 
                        ...
                        JOptionPane.showMessageDialog(null, "Vendor Details Deleted!", "", JOptionPane.INFORMATION_MESSAGE);
